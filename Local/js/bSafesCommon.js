...
function bSafesPreflight(fn) {
	...
	dbQueryInfo(server_addr + '/memberAPI/preflight', {
		...
		if(data.status === 'ok'){
			...
			//var thisDiscovery = localStorage.getItem("encodedGold");
			var thisDiscovery = data.encodedGold;
			...
			var encodedPrivateKeyEnvelope = data.encodedPrivateKeyEnvelope;
			...
			var encodedEnvelopeIV = data.encodedEnvelopeIV;
			...
			var encodedSearchKeyEnvelope = data.encodedSearchKeyEnvelope;
			...
			var encodedSearchKeyIV = data.encodedSearchKeyIV;
...
// function dbQueryLikeAjax(ajaxUrl, postData, fn) {
